...
flushPara(para);
const css = `:root{color-scheme:light dark;--bg:#fbfbf9;--fg:#1d1d1b;--code:#eeeee9;--line:#ddd;--link:#0b57d0}@media(prefers-color-scheme:dark){:root{--bg:#17181a;--fg:#e6e6e2;--code:#25272b;--line:#3a3d42;--link:#8ab4f8}}body{margin:0;font:16px/1.55 system-ui,-apple-system,Segoe UI,Roboto,sans-serif;background:var(--bg);color:var(--fg)}a{color:var(--link)}main{max-width:44rem;margin:0 auto;padding:1.2rem 1rem 4rem}nav{font-size:14px;display:flex;gap:1rem;padding:.8rem 1rem;border-bottom:1px solid var(--line)}nav a{color:inherit}h1{font-size:1.7rem;margin:.6rem 0}h2{margin-top:2rem;font-size:1.3rem}h3{font-size:1.05rem}code{font:13.5px ui-monospace,SFMono-Regular,Menlo,monospace;background:var(--code);color:var(--fg);padding:.1em .3em;border-radius:3px}pre{background:var(--code);padding:.7rem .9rem;border-radius:6px;overflow-x:auto}pre code{background:none;padding:0;word-break:break-all;white-space:pre-wrap}table{border-collapse:collapse;width:100%;font-size:15px}th,td{border:1px solid var(--line);padding:.35rem .5rem;text-align:left}li{margin:.25rem 0}`;
