...
export class CompileClient {
  ...
  constructor(opts: { beeUrl: string; packageIndex?: PackageIndex; allowFallback: boolean }) {
    ...
    const init: ToWorker = { type: 'init', beeUrl: opts.beeUrl, compilerUrl, fontIndex: fontIndex as FontIndexEntry[], packageIndex: opts.packageIndex ?? {}, allowFallback: opts.allowFallback };
