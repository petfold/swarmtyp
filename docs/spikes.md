...
- Consequences: D-22 gains an option; T14 does not apply in Freedom, since every hash is its own origin; D-20's subdomain-gateway argument is the same isolation Freedom gives natively.
